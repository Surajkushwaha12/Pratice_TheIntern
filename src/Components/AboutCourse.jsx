...
function AboutCourse() {
    return (
        <>
            <div className="relative h-[600px] w-full rounded-md my-5">
                <img
                ...
                <button className="mt-5  inline-flex cursor-pointer border bg-goldenrod shadow-xl shadow-goldenrod rounded-lg  px-2 items-center text-lg font-bold text-white">
                        Power BI
                    </button>
